// src/helpers/mockApi.ts
// ฐานข้อมูลจำลองสำหรับพัฒนา UI บนเครื่องเท่านั้น (?mock=1 บน localhost)
// ไฟล์นี้ถูก import แบบ dynamic เฉพาะตอน dev จึงไม่ติดไปกับ production bundle
...
export function handleMockRpc(fn: string, args: Record<string, any> = {}): any {
  initMockDB();
