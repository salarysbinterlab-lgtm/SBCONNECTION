...
function handlePasswordResetRequest_(body) {
  ...
  var lines = [
    ...
    "2. แจ้งรหัสยืนยัน 6 หลักข้างบนให้พนักงาน",
    "3. พนักงานกดปุ่ม ได้รับรหัสแล้ว ที่หน้าลืมรหัสผ่าน แล้วกรอกรหัสนี้ภายใน 3 นาที",
    "4. ผ่านแล้วระบบจะพาไปหน้าตั้งรหัสใหม่ ซึ่งไม่จำกัดเวลา",
    "",
    "หมายเหตุ: รหัสนี้ใช้ได้ครั้งเดียว และรหัสผ่านเดิมของพนักงานยังใช้ได้อยู่จนกว่าจะใช้รหัสนี้",
    "ถ้าพนักงานกรอกไม่ทัน 3 นาที ให้กดขอรหัสใหม่ที่หน้าเว็บ (ขอได้ 3 ครั้งต่อวัน)",
