> ⚠️ นโยบายรหัสผ่านเปลี่ยนแล้ว: ยาว 8-72 ตัว ต้องมีตัวอักษร+ตัวเลข ใช้อักขระพิเศษได้
> และรหัส `1234` / รหัสที่เท่ากับรหัสพนักงาน ใช้ไม่ได้อีกแล้ว ดู [RUNBOOK.md](RUNBOOK.md)
